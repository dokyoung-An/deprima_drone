...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me.__43.logicBlock_position = function() {
			...
			if (me.__43.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__43.style.transition='left 0s, top 0s, width 0s, height 0s';
				if (me.__43.ggCurrentLogicStatePosition == 0) {
					me.__43.style.left='0px';
					me.__43.style.top='315px';
				}
				else {
					me.__43.style.left='0px';
					me.__43.style.top='408px';
				}
			}
		}
		...
		me.__43.logicBlock_size = function() {
			...
			if (me.__43.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me.__43.ggCurrentLogicStateSize == 0) {
					me.__43.style.width='82px';
					me.__43.style.height='500px';
					skin.updateSize(me.__43);
				}
				else {
					me.__43.style.width='134px';
					me.__43.style.height='608px';
					skin.updateSize(me.__43);
				}
			}
		}
		...
		me.__44.logicBlock_position = function() {
			...
			if (me.__44.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__44.style.transition='left 800ms ease 0ms, top 800ms ease 0ms';
				if (me.__44.ggCurrentLogicStatePosition == 0) {
					me.__44.style.left='0%';
					me.__44.style.top='0px';
				}
				else if (me.__44.ggCurrentLogicStatePosition == 1) {
					me.__44.style.left='-20%';
					me.__44.style.top='0px';
				}
				else {
					me.__44.style.left='-200%';
					me.__44.style.top='0px';
				}
			}
		}
		...
		me.__65.logicBlock_position = function() {
			...
			if (me.__65.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me.__65.ggCurrentLogicStatePosition == 0) {
					...
					me.__65.style.bottom='10%';
				}
				else {
					me.__65.style.left='calc(50% - ((100px + 0px) / 2) + 0px)';
					me.__65.style.bottom='15%';
				}
			}
		}
		...
		me.__64.appendChild(me._image_9);
		me.__63.appendChild(me.__64);
		me.__44.appendChild(me.__63);
		...
		me.__62.logicBlock_position = function() {
			...
			if (me.__62.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me.__62.ggCurrentLogicStatePosition == 0) {
					me.__62.style.left = 'calc(50% - (100% / 2))';
					me.__62.style.bottom='10%';
				}
				else {
					me.__62.style.left='calc(50% - ((100% + 0px) / 2) + 0px)';
		...
		me.__61.appendChild(me._image_8);
		me.__60.appendChild(me.__61);
		me.__44.appendChild(me.__60);
		...
		me.__59.logicBlock_position = function() {
			...
			if (me.__59.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me.__59.ggCurrentLogicStatePosition == 0) {
					me.__59.style.left = 'calc(50% - (100px / 2))';
					me.__59.style.bottom='10%';
				}
				else {
					me.__59.style.left='calc(50% - ((100px + 0px) / 2) + 0px)';
		...
		me.__58.appendChild(me._image_7);
		me.__57.appendChild(me.__58);
		me.__44.appendChild(me.__57);
		...
		me.__56.logicBlock_position = function() {
			...
			if (me.__56.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me.__56.ggCurrentLogicStatePosition == 0) {
					...
					me.__56.style.bottom='14%';
				}
				else {
					me.__56.style.left='calc(50% - ((100px + 0px) / 2) + 0px)';
					me.__56.style.bottom='19%';
				}
			}
		}
		...
		me.__49.appendChild(me._image_4);
		...
		me.__47.logicBlock_position = function() {
			...
			if (me.__47.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me.__47.ggCurrentLogicStatePosition == 0) {
					...
					me.__47.style.bottom='18%';
				}
				else {
					me.__47.style.left='calc(50% - ((100px + 0px) / 2) + 0px)';
					me.__47.style.bottom='21%';
				}
			}
		}
		...
		me.__46.appendChild(me._image_3);
		...
		me.__42.appendChild(me._image_2);
 ...
 let url = '';
  ...
  document.body.removeChild(textarea);
		...
		me.__38.logicBlock_textcolor = function() {
			...
			if (me.__38.ggCurrentLogicStateTextColor != newLogicStateTextColor) {
				me.__38.ggCurrentLogicStateTextColor = newLogicStateTextColor;
				me.__38.style.transition='color 0s';
				if (me.__38.ggCurrentLogicStateTextColor == 0) {
					me.__38.style.color="rgba(255,255,255,1)";
				}
				else {
					me.__38.style.color="rgba(0,0,0,1)";
				}
			}
		}
		me.__38.logicBlock_textcolor();
		...
		me.__36.appendChild(me._rectangle_111111);
		...
		me.__30.logicBlock_backgroundcolor = function() {
			...
			if (me.__30.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				...
				if (me.__30.ggCurrentLogicStateBackgroundColor == 0) {
					me.__30.style.backgroundColor="rgba(34,30,31,1)";
				}
				else {
		...
		me.__31.logicBlock_textcolor = function() {
			var newLogicStateTextColor;
			if (
				((player.getVariableValue('vis_business') == true))
			)
			...
			if (me.__31.ggCurrentLogicStateTextColor != newLogicStateTextColor) {
				me.__31.ggCurrentLogicStateTextColor = newLogicStateTextColor;
				me.__31.style.transition='color 0s';
				if (me.__31.ggCurrentLogicStateTextColor == 0) {
					me.__31.style.color="rgba(255,255,255,1)";
				}
				else {
					me.__31.style.color="rgba(0,0,0,1)";
				}
			}
		}
		me.__31.logicBlock_textcolor();
		...
		me.__30.appendChild(me._rectangle_1111);
		me.__29.appendChild(me.__30);
		me.__18.appendChild(me.__29);
		...
		me.__25.logicBlock_backgroundcolor = function() {
			...
			if (me.__25.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				...
				if (me.__25.ggCurrentLogicStateBackgroundColor == 0) {
					me.__25.style.backgroundColor="rgba(34,30,31,1)";
				}
				else {
					me.__25.style.backgroundColor="rgba(255,255,255,1)";
				}
			}
		}
		...
		me.__26.logicBlock_textcolor = function() {
			var newLogicStateTextColor;
			if (
				((player.getVariableValue('vis_around') == true))
			)
			...
			if (me.__26.ggCurrentLogicStateTextColor != newLogicStateTextColor) {
				me.__26.ggCurrentLogicStateTextColor = newLogicStateTextColor;
				me.__26.style.transition='color 0s';
				if (me.__26.ggCurrentLogicStateTextColor == 0) {
					me.__26.style.color="rgba(255,255,255,1)";
				}
				else {
					me.__26.style.color="rgba(0,0,0,1)";
				}
			}
		}
		me.__26.logicBlock_textcolor();
		...
		me.__25.appendChild(me._rectangle_111);
		me.__24.appendChild(me.__25);
		me.__18.appendChild(me.__24);
		...
		me.__20.logicBlock_backgroundcolor = function() {
			...
			if (me.__20.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				...
				if (me.__20.ggCurrentLogicStateBackgroundColor == 0) {
					me.__20.style.backgroundColor="rgba(34,30,31,1)";
				}
				else {
		...
		me.__21.logicBlock_textcolor = function() {
			var newLogicStateTextColor;
			if (
				((player.getVariableValue('vis_home') == true))
			)
			...
			if (me.__21.ggCurrentLogicStateTextColor != newLogicStateTextColor) {
				me.__21.ggCurrentLogicStateTextColor = newLogicStateTextColor;
				me.__21.style.transition='color 0s';
				if (me.__21.ggCurrentLogicStateTextColor == 0) {
					me.__21.style.color="rgba(255,255,255,1)";
				}
				else {
					me.__21.style.color="rgba(0,0,0,1)";
				}
			}
		}
		me.__21.logicBlock_textcolor();
		...
		me.__20.appendChild(me._rectangle_1);
  ...
  document.body.removeChild(textarea);
		...
		me.__7.logicBlock_position = function() {
			...
			if (me.__7.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__7.style.transition='left 0s, bottom 0s, transform 0s';
				if (me.__7.ggCurrentLogicStatePosition == 0) {
					me.__7.style.left = 'calc(50% - (280px / 2))';
					me.__7.style.bottom='10px';
				}
				else {
					me.__7.style.left='calc(50% - ((280px + 0px) / 2) + 0px)';
					me.__7.style.bottom='50px';
				}
			}
		}
		...
		me._rectangle_2.appendChild(me.__16);
		...
		me._rectangle_3.appendChild(me.__14);
		...
		me._rectangle_4.appendChild(me.__12);
		me.__11.appendChild(me._rectangle_4);
		...
		me._rectangle_5.appendChild(me.__10);
		me.__9.appendChild(me._rectangle_5);
		...
		me.__3.logicBlock_position = function() {
			...
			if (me.__3.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me.__3.ggCurrentLogicStatePosition == 0) {
					...
					me.__3.style.left='calc(50% - ((70% + 0px) / 2) + 0px)';
					me.__3.style.top='6%';
				}
			}
		}
		...
		me.__3.logicBlock_size = function() {
			...
			if (me.__3.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me.__3.ggCurrentLogicStateSize == 0) {
					me.__3.style.width='85%';
					me.__3.style.height='69.13%';
					me.__3.style.left = 'calc(50% - (85% / 2))';
					skin.updateSize(me.__3);
				}
				else if (me.__3.ggCurrentLogicStateSize == 1) {
					me.__3.style.width='88%';
					me.__3.style.height='75%';
					me.__3.style.left = 'calc(50% - (88% / 2))';
					skin.updateSize(me.__3);
				}
				else {
					me.__3.style.width='70%';
					me.__3.style.height='78%';
					me.__3.style.left = 'calc(50% - (70% / 2))';
					skin.updateSize(me.__3);
				}
			}
